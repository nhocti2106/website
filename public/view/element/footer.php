    ...
    <div class="container">
        <div class="row row-pb-md">
            <div class="col-5 footer-col colorlib-widget ">
                <h2 class="text-white fs-2">PGM</h2>
                <p class="text-white fs-6 ">PGM chuyên cung cấp các mặt hàng thời trang cao cấp</p>
                <p class="text-white fs-6 text mb-0"><i class="fa-solid fa-location-dot"></i>
                    Địa chỉ: 236B Lê Văn Sỹ, phường 1, quận Tân Bình, Thành phố Hồ Chí Minh.</p>
            ...
            <div class="col-sm-12 text-center">
                <p>
                    <span class="text-white">
                        ...
                        </script> All rights reserved | Design by Mẫn
                    </span>
                </p>
            </div>
        </div>
